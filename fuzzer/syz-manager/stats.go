...
func (mgr *Manager) initStats() {
	...
	prometheus.Register(promauto.NewGaugeFunc(prometheus.GaugeOpts{
		Name: "syz_corpus_signal",
		Help: "Corpus signal during current execution of syz-manager",
	},
		func() float64 { return float64(mgr.stats.corpusSignal.get()) },
	))
	prometheus.Register(promauto.NewGaugeFunc(prometheus.GaugeOpts{
		Name: "syz_max_signal",
		Help: "Max signal during current execution of syz-manager",
	},
		func() float64 { return float64(mgr.stats.maxSignal.get()) },
	))
}
