...
from AssignExpr ae,
 ...
 select ifs.getLocation(), f1.getName() + " | " + l2.getValue() + " | " + (s.getName() + ":" + pfa.getTarget().getName()) + " | " + vo.getvalue().toString() + " | " + ifs.getLocation().getFile().toString() + " | " + ifs.getLocation().getStartLine().toString() + " | " + ae.getLocation().getFile().toString() + " | " + ae.getLocation().getStartLine().toString()