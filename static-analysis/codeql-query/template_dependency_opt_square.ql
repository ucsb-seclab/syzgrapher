...
select ifs.getLocation(), eca2.getValue() + " | " + eca2.toString() + " | " + vof.getvalue().toString() + " | " + voi.getvalue().toString() + " | " + ifs.getLocation().getFile().toString() + " | " + ifs.getLocation().getStartLine().toString() + " | " + fc.getLocation().getFile().toString() + " | " + fc.getLocation().getStartLine().toString() + " | " + vof.getkind() + " | " + voi.getkind()   