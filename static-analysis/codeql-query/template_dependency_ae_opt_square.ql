...
from AssignExpr ae,
 ...
 select ifs.getLocation(), eca2.getValue() + " | " + eca2.toString() + " | " + vof.getvalue().toString() + " | " + voi.getvalue().toString()  + " | " + ifs.getLocation().getFile().toString() + " | " + ifs.getLocation().getStartLine().toString() + " | " + ae.getLocation().getFile().toString() + " | " + ae.getLocation().getStartLine().toString() + " | " + vof.getkind() + " | " + voi.getkind()
